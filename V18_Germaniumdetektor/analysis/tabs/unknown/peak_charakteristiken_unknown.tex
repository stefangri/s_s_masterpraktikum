...
\toprule  
{$Channelnummer / \si{ }$} & {$Übergangswahrscheinlichkeit / \si{ }$} & \multicolumn{2}{c}{$Amplitude \:/\: \si{ }$} & \multicolumn{2}{c}{$\sigma \:/\: \si{ \kilo\eV}$} & \multicolumn{2}{c}{$\mu \:/\: \si{ \kilo\eV}$} & {$Fläche / \si{ }$} & \multicolumn{2}{c}{$Aktivität \:/\: \si{ \Bq}$} \\ 
\midrule  
